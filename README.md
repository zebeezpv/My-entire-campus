...
Commit the changes. Vercel should redeploy automatically. Refresh the deployed app twice so the Phase 10 service worker replaces the old cache.
...
Every feature page now shows a sticky **← Dashboard** button in the top-left corner. It returns directly to the Dashboard, including from Grade Calculator, Calendar, Planner, Tasks, Resources, Revision, Settings and the other tools. Existing Phase 9 browser data is migrated automatically.
